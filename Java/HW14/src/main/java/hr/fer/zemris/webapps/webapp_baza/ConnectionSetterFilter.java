...
import hr.fer.zemris.webapps.webapp_baza.dao.sql.SQLConnectionProvider;

/**
 * Intercepts a request and ensures that the connection from a
 * {@code DataSource} will be available for the requested servlet.
 * 
 * @author Dan
 */
@WebFilter("/*")
